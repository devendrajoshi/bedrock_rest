...
async def generate_response(request: RequestModel):
    try:
        ...
        return {"email_response": generate_acknowledgment_email(responses)}
...
def generate_acknowledgment_email(response):
    
    
    email_text = """
Subject: Acknowledgment of Your Support Request

Dear Sender,

Thank you for reaching out to us. We have received your queries and our customer support team will be responding to your email shortly. In the meantime, please find below the answers generated by our support bot for your reference:
...
We appreciate your patience and understanding. Our team is dedicated to resolving your issues as quickly as possible.
